...
//Display the background image.
        ...
        //score
        g.drawString("Score:"+ sh, 50, YBORDER+25);
        g.drawString("High Score:"+ hs, 100, YBORDER+25);
...
//Display the rocket.
        ...
        g.fillRect(350, 10, 100, XBORDER+15);
        }
        if(th<=1)
        g.fillRect(300, 10, 100, XBORDER+15);
        if(th<=0)
        g.fillRect(250, 10, 100, XBORDER+15);
